...
use crate::{get_memory_type_index, pipeline::Vertex, AppData, INDICES, VERTICES};
use anyhow::Result;
use vulkanalia::{
...
pub(crate) unsafe fn create_index_buffer(instance: &Instance, device: &Device, data: &mut AppData) -> Result<()> {
...
pub(crate) unsafe fn create_uniform_buffers(instance: &Instance, device: &Device, data: &mut AppData) -> Result<()> {
